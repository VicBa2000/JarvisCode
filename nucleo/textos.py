...
AJUSTES_EN: dict[str, str] = {
    ...
    # >>> `carcasa.sin_carpeta` SE FUE DE AQUI (2026-09-10) <<<
    # No lo leia nadie -- comprobado con un barrido del arbol -- y
    # ademas decia "set it in the settings (config/ajustes.yaml, key
    # sesion.carpeta)", que es EXACTAMENTE el mensaje que se quito del
    # lado español el 2026-09-05 por mandar a alguien nuevo a editar un
    # YAML. Una traduccion muerta de un texto que ya no existe no es
    # inofensiva: es la unica version de ese mensaje que quedaba en
    # pie, y decia lo contrario de lo que hace el programa.
    # Hoy la carpeta se elige en un selector; ese es el titulo.
    "carcasa.elige_carpeta": "Choose the folder Jarvis will work in",
    "carcasa.no_reinicio":
