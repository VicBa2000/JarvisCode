...
║                                                                              ║
║            1525 tests  ·  4 temas  ·  2 idiomas  ·  solo Windows             ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
...
<p align="center">
  <img alt="Jarvis funcionando: se le habla, y Claude Code trabaja sobre el proyecto"
       src="https://github.com/VicBa2000/JarvisCode/releases/download/v0.1.0/jarvis-demo.gif"
       width="720">
</p>

<p align="center">
  <sub>Ejemplo de una sesión real</sub>
</p>
...
La primera vez que arranca, Jarvis pregunta **en qué carpeta va a
trabajar** y la recuerda; a partir de ahí ya no vuelve a preguntarlo. Esa
carpeta se cambia cuando se quiera en la pestaña de ajustes, y no hace
falta editar ningún archivo.
...
El uso habitual es `jarvis.bat`, o el acceso directo del Escritorio. Los
equivalentes por línea de órdenes:

```powershell
:: la aplicación, sin terminal (lo que hace jarvis.bat)
.venv\Scripts\pythonw.exe -m escritorio --voz
...
**La carpeta es opcional en `-m escritorio`**: sin ella se usa la que esté
guardada en los ajustes, y si todavía no hay ninguna se pregunta al
arrancar. Pasarla por la línea de órdenes la fuerza solo para esa vez, sin
tocar la guardada, que sirve para abrir otro proyecto sin cambiar nada. En
`-m puente` sí es obligatoria: ese camino no tiene ventana desde la que
preguntar.
...
| Máquina de desarrollo, con las cinco voces y todo configurado | 1525 pasan · 1 saltado · 0 fallos |
